...
public class DatabaseConnector{
  ...
  public DatabaseConnector(String pIP, int pPort, String pDatabase, String pUsername, String pPassword){
    ...
    try {
      ...
      String pathToDB = this.getClass().getClassLoader().getResource(pDatabase).toString(); //Eine von Ambro eingefügte Zeile, um einen relativen Pfad zu finden.

      //Verbindung herstellen
      //connection = DriverManager.getConnection("jdbc:sqlite:"+pDatabase);   <- Originalzeile. Benötigt dann jedoch absolute Pfade
